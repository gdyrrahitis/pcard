...
export const FooterComponent: ng.IComponentOptions = {
    ...
    controller: class FooterComponent {
        ...
        public freePikUrl: string = "http://www.freepik.com";
        public flatIconsUrl: string = "http://www.flaticon.com";
        public creativeCommonsUrl: string = "http://creativecommons.org/licenses/by/3.0/";
    }
};