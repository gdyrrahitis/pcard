...
xdescribe("Controller", () => {
    ...
    beforeEach(() => {
        ...
        angular.module("app", ["ui.bootstrap", "ngSanitize", "ngRoute", "ngStorage"])
            ...
            .controller("homeController", ["$scope", "$location", "$localStorage", "socketService", "notificationService", "modalService", "httpService", HomeComponent])
    ...
    describe("Home", () => {
        ...
        let createController: () => HomeComponent;
        let socketService;
        ...
        beforeEach(angular.mock.inject(function ($rootScope: any, $controller: any,
            ...
            createController = () => {
                return <HomeComponent>$controller("homeController", {
                    $scope: $scope,
                    locationService,
                    localStorage,
                    socketService,
