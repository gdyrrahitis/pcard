...
export class ServerHandlers {
    ...
    public createPrivateRoom = (data, callback) => {
    ...
    public joinPrivateRoom = (data, callback) => {
    ...
    public getAllConnectedUsers = (room) => this.emitEventToRoom(room, this.showAttendeesEvent, this.connections);
}